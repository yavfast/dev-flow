...
- Contributors may add to shared sections (Description, Coordination Notes, Blocking Issues, Relevant Context, Activity Log) but **must not rewrite another contributor's tagged entries or subtask blocks**.
- Coordination between contributors happens via the file's **Coordination Notes** section.
...
**No exclusive locks.** There is no time-based ownership takeover. If a contributor's Subtask is stale and another wants to continue that line of work, they add a *new* Subtask block referencing the original. The original block remains untouched as a historical record.
...
- [task_20260815_085500_adopt-agent-reach](task_20260815_085500_adopt-agent-reach.md) — done 2026-08-15 — adoption analysis of `Panniantong/agent-reach`
