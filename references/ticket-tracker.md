...
Otherwise: no activation, no tracker calls.
...
The discovered integration is the **single authority** on the tracker's conventions. dev-flow hardcodes none of them.
